...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var secondMaineSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
...
/*#__PURE__*/
function () {
  function Difference(oldOfficer, newOfficer, itemClass) {
  ...
  _createClass(Difference, [{
    key: "bindTrigger",
    value: function bindTrigger(container, items) {
      var counter = 0;
...
function () {
  ...
  _createClass(Forms, [{
    ...
    key: "clearInputs",
    value: function clearInputs(input) {
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "showFloatElement",
    value: function showFloatElement(slideIndex, elementSelector, delay) {
      if (this.slideNumber == slideIndex) {
        var item = document.querySelector(elementSelector);
        item.style.display = 'none';
        setTimeout(function () {
    ...
    key: "bindClickEvent",
    value: function bindClickEvent(arrowNavSel) {
      var _this = this;

      var next = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
      document.querySelectorAll(arrowNavSel).forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();

          _this.plusSlides(next);
        });
      });
    }
  }, {
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          try {
            _this2.showFloatElement(2, '.hanson', 3000);
          } catch (e) {}
        });
        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          _this2.showSlide(_this2.slideNumber);
        });
      });
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, autoplay, animate, activeClass, slideClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, autoplay, animate, activeClass, slideClass));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTrigers() {
      ...
      this.prev.addEventListener('click', function () {
        var last = _this2.slides.length - 1;

        _this2.container.insertBefore(_this2.slides[last], _this2.slides[0]);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      slideClass = _ref$slideClass === void 0 ? false : _ref$slideClass;
