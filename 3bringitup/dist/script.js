...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, autoplay, animate, activeClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, autoplay, animate, activeClass));
  }
