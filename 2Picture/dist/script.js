...
/* harmony import */ var _modules_scrollPage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/scrollPage */ "./src/js/modules/scrollPage.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vervical');
  ...
  Object(_modules_scrollPage__WEBPACK_IMPORTED_MODULE_11__["default"])('.pageup');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burgerMenu = function burgerMenu(menuSelector, burgerSelector) {
...
var calc = function calc(form, sizeSel, materialSel, optionSel, promoSel, divSel) {
  var formWrapper = document.querySelector(form),
...
var changeImg = function changeImg(block) {
  var blockItems = document.querySelectorAll(block);
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      if (item.classList.contains('calc_form')) {
        ...
        formData.set('sum', resultBlock.textContent);
      }
...
function modals() {
  ...
  var id = showModalByTime('.popup-consultation', 60000);

  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var pageYOffset = Math.ceil(window.pageYOffset + document.documentElement.clientHeight);
      var fullScrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight);
...
var scrollPage = function scrollPage(upSelector) {
  ...
  }); //scroling with requestAnimationFrame
...
var showMoreStyles = function showMoreStyles(triger, wrapper) {
  var stylesContainer = document.querySelector(wrapper),
...
var tabs = function tabs(headerSelector, tabSelector) {
  var menu = document.querySelector(headerSelector),
      menuItem = document.querySelectorAll("".concat(headerSelector, ">li")),
      content = document.querySelectorAll(tabSelector);
  var count = ['all', 'lovers', 'chef', 'girl', 'guy', 'grandmother', 'granddad'];
  ...
  function showContent(className) {
    content.forEach(function (item) {
      ...
      } else if (className == 'grandmother' || className == 'granddad') {
        //have not image
