...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active'); //all tab content active

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState);
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.container1', new Date('2020-07-02T03:24:00'));
...
function modals() {
  function bindModal(trigerSelector, modalSelector, closeSelector) {
    ...
    triger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px"); //document.body.style.overflow = 'hidden';
        //clearTimeout(id);
      });
    });
    close.addEventListener('click', function (e) {
      ...
      document.body.classList.remove('modal-open');
      document.body.style.marginRight = "0px"; //document.body.style.overflow = '';
    });
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); //let id = showModalByTime('.popup', 60000);
